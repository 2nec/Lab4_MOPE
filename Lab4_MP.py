...
def main(m, n):
    ...
    if n == 8:
        t = PrettyTable(['N', 'norm_x_0', 'norm_x_1', 'norm_x_2', 'norm_x_3', 'norm_x_1_x_2', 'norm_x_1_x_3', 'norm_x_2_x_3',
             'norm_x_1_x_2_x_3', 'x_1', 'x_2', 'x_3', 'x_1_x_2', 'x_1_x_3', 'x_2_x_3',
    ...
    if n == 8:
        print(
            f"Нормоване рівняння регресії: y = {beta_i[0]:.5f} + {beta_i[1]:.5f} * x1 + {beta_i[2]:.5f} * x2 + "
    ...
    if f_p > f_t[f_3][f_4]:
        print(
            ...
            f"\nПроводимо експеримент знову з m = m + 1")
        main(m=m + 1, n=8)
        global count
        count += 1
    else:
